...
=== Address Book
The address book feature handles the contact list of the users. Users are able to:
...
image::UndoRedoState1edited.png[]

Step 3. The user executes `add n\David ...` to add a new person. The `add` command also calls `Model#commitAddressBook()`, causing another modified address book state to be saved into the `addressBookStateList`.

image::UndoRedoState2edited.png[]
...
|`* * *` |student |edit category specific remark |edit the remark if needed

|`* * *` |student | delete category specific remark |category specific remark is not needed anymore

|`* * *` |student |list all my contacts |keep track of my contact list

|`* * *` |student |list my contacts according to category |keep track of my contact list according to different category

|`* * *` |student |undo my command under Address Book feature |

|`* * *` |student |redo my command under Address Book feature |
