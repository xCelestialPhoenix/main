...
// tag::view[]
=== View schedule
The view schedule feature allows the user to view their schedule either for a specified day or for a week.

==== Implementation
View day: Given below is an example usage scenario and how the view day mechanism behaves at each step.
...
[discrete]
=== Use case 14: View the schedule for a day
...
[discrete]
=== Use case 15: View the schedule for a week
