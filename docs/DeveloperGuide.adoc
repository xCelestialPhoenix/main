...
`Main` has two classes called link:{repoURL}/src/main/java/seedu/nova/Main.java[`Main`] and link:{repoURL}/src/main/java/seedu/nova/MainApp.java[`MainApp`]. It is responsible for,
