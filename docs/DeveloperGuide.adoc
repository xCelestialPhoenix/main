...
(For all use cases below, the *System* is the `NOVA` and the *Actor* is the `user`, unless specified otherwise)

[discrete]
=== Use case: Add notes to a project task in project section of progress tracker
...
[none]
* 2a. No such project task exist.
*   2a1. NOVA shows an error message.
+
Use case ends.

=== Use case: User edits a note.
...
[none]
* 2a. No prior note was added.
*   2a1. NOVA adds edit as new note.
+
Use case ends.

=== Use case: User deletes a note.
...
[none]
* 2a. Note to be deleted does not exist.
*   2a1. NOVA shows error message.
+
Use case ends.
