...
|`* * *` |Student | Auto-generate event from a task | If I feel like I want to do a study task today, I can generate an event on today's schedule, or any day.

|`* *`   |Student | View statistics of my task progress | Can see how much I've done for each tasks on my study plan.
...
2.  Study Planner of NOVA calculates all the statistics of every tasks.
3.  NOVA shows all the statistics of every task.
+
Use case ends.
...
2.  Study Planner of NOVA generates an event based on the current schedule and the task requirements.
3.  NOVA adds the generated event into schedule.
+
Use case ends.
