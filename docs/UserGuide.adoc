...
Format: `add n\[name] p\[phone number] c\[classmate/teammate]`
...
Format: `edit n\[name] p\[phone number] c\[classmate/teammate]`
...
Example: +
`addpic n\john doe pa\C:\Users\aloha\Desktop\aloha.png`
...
Format: `updatepic n\[name] pa\[path]`
...
Example: +
`updatepic n\john doe pa\C:\Users\aloha\Desktop\updatedAloha.png`
...
Format: `deletepic n\[name]`

[NOTE]
`[name]` is not case-sensitive. (E.g. "Jane doe" is the same as "jane Doe")

Example: +
`deletepic n\john doe`
...
Format: `remark c\[classmate/teammate] n\[name] d\[description]`

[NOTE]
`[name]` is not case-sensitive. (E.g. "Jane doe" is the same as "jane Doe")

Example: +
`remark c\teammate n\john DOE d\He's cuteeee!`
