...
running soon. There is an entire section dedicated to how to use any particular feature in NOVA. If there are any
terms that you are unsure of, check out the glossary to know the meaning.
