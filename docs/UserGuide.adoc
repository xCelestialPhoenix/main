...
Example: +
If you wish to add a project meeting into your schedule, which is from 2pm to 3pm on 20 February 2020, +

`meeting d\CS2103T website set-up v\COM1 t\2020-02-20 14:00 15:00`

NOVA creates an event for a team meeting at COM1 on 20 February 2020 to set up CS2103T website from 2pm to 3pm.
...
Example: +
If you wish to add a group study session from 4pm to 5pm on 20 February 2020, +

`study d\cool peeps revision v\COM1 t\2020-02-20 16:00 17:00`

NOVA creates an event for study session at COM1 on 20 Feb 2020 from 4pm to 5pm.
...
Example: +
If you wish to add a consultation session from 3pm to 4pm on 20 February 2020, +

`consultation d\clarify UML v\COM1 t\2020-02-20 15:00 16:00`

NOVA creates an event for consultation at COM1 on 20 Feb 2020 to clarify UML from 3pm to 4pm.
...
If you wish to add a weekly lesson from 3pm to 4pm on Friday, +

`lesson d\CS2103T tutorial v\COM1-B103 t\Friday 15:00 16:00`

NOVA creates events for CS2103T tutorial at COM1-B103 on Friday from 3pm to 4pm for the entire semester.
...
After doing `view t\2020-2-20`, you realise you do not want the second event in the printed list, +

`delete t\2020-02-20 i\2`

NOVA deletes the second event on 20 Feb 2020.
...
If you wish to add a note that indicates the work allocation to a meeting event, +

`note d\Alice - Logic component in DG, Bob - UI component in DG t\2020-02-20 i\2`

NOVA adds a note with description "Alice - Logic component in DG, Bob - UI component in DG"
