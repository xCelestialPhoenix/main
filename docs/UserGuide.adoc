...
* `contact addpic n\John Doe pa\C:\Users\aloha\Desktop\john.png`
...
* `contact updatepic n\John Doe pa\C:\Users\aloha\Desktop\doe.png`
...
* `contact remark c\teammate n\John Doe d\He's cute`
