...
you up and running soon.

There is an entire <<Features, section>> dedicated to how to use any particular feature in NOVA with examples provided
for your better understanding. We have also provided a <<Summary, summary of commands>> for your quick reference. Should you
...
// tag::view[]
==== View Schedule of a Day: `view` (Terence Ng)
...
==== View Schedule of a Week: `view` (Terence Ng)
...
==== Find Free Slots: `freeslot` (Terence Ng)
...
.2+| Common
| exit | Exits NOVA
| nav [home/ ab/ schedule/ planner/ progresstracker] | Changes the mode of NOVA
...
| flexible p\[task name] t\[total minutes] mind\[maximum event duration in minutes] maxd\[maximum event duration in minutes] | Creates a flexible task
| routine p\[task name] f\[daily/weekly] d\[event duration in minutes]| Creates a routine task
| schedule p\[task name] t\[YYYY-MM-DD] | Schedules a tasks in the schedule
