...
**Please use `list`, `list c\teammate`, `list c\classmate` or `find` command before you edit contact.**
...
image::userguide/addressbook_list.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2.5.1: Example display message after entering `list`#_

`edit i\1 p\88888888`

NOVA will edit the phone number of the first contact in your list to 88888888 as shown below.

image::userguide/addressbook_edit.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2.5.2: Successfully changed Alex Yeoh's phone number#_

<<Top, [Back to Top]>>

==== Add, Edit or Delete Remark: `remark`
You can add remarks that are category specific, to a contact. +
**Please use `list`, `list c\teammate`, `list c\classmate` or `find` command before you add, edit or delete remark to your contact.**
...
Example: +
Suppose you want add remark to Bernice Yu in your address book after using `list` as show below,

image::userguide/addressbook_list.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2.6.1: Example display message after entering `list`#_

type the command: `remark i\2 r\She's a nice teammate`
...
[.text-center]
_[.small]#Fig 5.2.6.2: Successfully added remark to Bernice Yu#_

<<Top, [Back to Top]>>

==== Delete Contact: `delete`
You can delete a contact that you have added. If the contact you try to delete does not exist, NOVA will let you know. +
**Please use `list`, `list c\teammate`, `list c\classmate` or `find` command before you delete contact.**
...
Example: +
Suppose you want to delete Alex Yeoh's contact after using the `list` as shown below,

image::userguide/addressbook_list.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2.7.1: Example display message after entering `list`#_
...
[.text-center]
_[.small]#Fig 5.2.7.2: Successfully deleted Alex Yeoh#_
...
image::userguide/EventMeeting.png[width="590" align="center"]
[.text-center]
...
image::userguide/EventStudy.png[width="590" align="center"]
[.text-center]
...
image::userguide/EventConsultation.png[width="590" align="center"]
[.text-center]
...
==== Add a Lesson: `lesson`
You can add a weekly lesson as one of your events.
If there is already an event in the time slot, NOVA will inform you.
...
image::userguide/EventLesson.png[width="590" align="center"]
[.text-center]
...
image::userguide/EventDelete.png[width="590" align="center"]
[.text-center]
...
image::userguide/EventNote.png[width="590" align="center"]
[.text-center]
...
image::userguide/schedule_view_week.png[width="590" align="center"]
[.text-center]
