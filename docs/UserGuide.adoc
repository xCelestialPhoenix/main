...
your teammates and classmates, and contacts are automatically sorted alphabetically. +
...
* The `[index]` must be a positive integer. (E.g. 1, 2, 3, ...)
* To remove any remarks that you have added for a contact, use `remark i\[index] r\` or `remark i\[index]`
====
