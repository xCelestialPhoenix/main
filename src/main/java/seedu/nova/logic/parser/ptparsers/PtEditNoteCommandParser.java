...
/**
 * Parses input arguments and creates a new PtEditNoteCommand object
 */
public class PtEditNoteCommandParser implements Parser<PtEditNoteCommand> {

    @Override
    public PtEditNoteCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        if (!arePrefixesPresent(argMultimap, CliSyntax.PREFIX_PROJECT, CliSyntax.PREFIX_WEEK, CliSyntax.PREFIX_TASK,
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, PtEditNoteCommand.MESSAGE_USAGE));
        }
        ...
        return new PtEditNoteCommand(week, taskNum, project, note);
    }
