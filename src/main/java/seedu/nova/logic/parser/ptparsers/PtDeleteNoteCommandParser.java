...
/**
 * Parses input arguments and creates a new PtDeleteNoteCommand object
 */
public class PtDeleteNoteCommandParser implements Parser<PtDeleteNoteCommand> {

    @Override
    public PtDeleteNoteCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        if (!arePrefixesPresent(argMultimap, CliSyntax.PREFIX_PROJECT, CliSyntax.PREFIX_WEEK, CliSyntax.PREFIX_TASK)
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, PtDeleteNoteCommand.MESSAGE_USAGE));
        }
        ...
        return new PtDeleteNoteCommand(week, taskNum, project);
    }
