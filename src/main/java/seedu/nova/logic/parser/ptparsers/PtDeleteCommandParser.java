...
/**
 * Parses input arguments and creates a new PtDeleteCommand object
 */
public class PtDeleteCommandParser implements Parser<PtDeleteCommand> {

    @Override
    public PtDeleteCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        if (!arePrefixesPresent(argMultimap, CliSyntax.PREFIX_PROJECT, CliSyntax.PREFIX_WEEK, CliSyntax.PREFIX_TASK)
            ...
            throw new ParseException(String.format(MESSAGE_INVALID_COMMAND_FORMAT, PtDeleteCommand.MESSAGE_USAGE));
        }
        ...
        return new PtDeleteCommand(week, project, taskNum);
    }
