...
class AbRemarkCommandTest {
    ...
    void execute_addRemarkUnfilteredList_success() {
        Person firstPerson = model.getAddressBookManager().getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased());
        ...
        Model expectedModel = new ModelManager(new AddressBook(model.getAddressBookManager().getAddressBook()), new UserPrefs(),
