...
import seedu.nova.logic.parser.ptparsers.PtDeleteCommandParser;
import seedu.nova.model.progresstracker.Project;
import seedu.nova.model.progresstracker.PtTask;
import seedu.nova.testutil.PtTaskBuilder;

public class PtDeleteCommandParserTest {
    private PtDeleteCommandParser parser = new PtDeleteCommandParser();
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + PROJECT_IP + WEEK_ONE + PT_TASK,
                new PtDeleteCommand(expectedPtTask.getPtWeek(), expectedPtTask.getProject().getProjectName(),
                        1));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, PtDeleteCommand.MESSAGE_USAGE);
