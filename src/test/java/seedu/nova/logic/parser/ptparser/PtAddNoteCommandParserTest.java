...
import seedu.nova.logic.parser.ptparsers.PtAddNoteCommandParser;
...
public class PtAddNoteCommandParserTest {
    private PtAddNoteCommandParser parser = new PtAddNoteCommandParser();
    ...
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, PtAddNoteCommand.MESSAGE_USAGE);
